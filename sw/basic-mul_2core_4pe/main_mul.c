...
static char* const FFT2_START_ADDR = (char* const)(0x93000000);
static char* const FFT2_READ_ADDR  = (char* const)(0x93000004);
static char* const FFT3_START_ADDR = (char* const)(0xA3000000);
static char* const FFT3_READ_ADDR  = (char* const)(0xA3000004);
// DMA 
