...
public:
	...
	addr_t mul_start_addr = 0x73000000;
 	addr_t mul_size = 0x01000000;
 	addr_t mul_end_addr = mul_start_addr + mul_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > mul_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.mul_start_addr, opt.mul_end_addr);
